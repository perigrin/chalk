#!/usr/bin/env perl
# ABOUTME: Progressive testing to find where lex.t fails
# ABOUTME: Test in 10-line increments to find failing region
use 5.42.0;
use utf8;
use lib 'lib';
...
print "Progressive lex.t parsing test\n";
