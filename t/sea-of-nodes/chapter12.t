    ...
    return sub {
        ...
        if ($key =~ /^node:(\d+)$/) {
            ...
            if (exists $nodes{$node_id}) {
                ...
                # Constant nodes don't take context parameter
...
subtest 'Float arithmetic: multiplication' => sub {
    ...
    my $right = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(4.0),
        value => 4.0,
    );
...
subtest 'Float arithmetic: division' => sub {
    my $start = Chalk::IR::Node::Start->new();
    my $left = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(10.0),
        value => 10.0,
    );
    my $right = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(4.0),
...
subtest 'Float comparison: equality' => sub {
    ...
    # Test equal values
    my $left1 = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(3.14),
        value => 3.14,
    );
    my $right1 = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(3.14),
        value => 3.14,
    );
    ...
    my $right2 = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(2.71),
        value => 2.71,
    );
...
subtest 'Float comparison: less than' => sub {
    ...
    my $left3 = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(3.5),
        value => 3.5,
    );
    my $right3 = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(3.5),
        value => 3.5,
    );
...
subtest 'Float edge cases: NaN' => sub {
    ...
    my $const_nan = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant($nan),
        value => $nan,
    );
...
subtest 'Float edge cases: Infinity' => sub {
    ...
    my $const_pos = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant($pos_inf),
        value => $pos_inf,
    );
    my $const_neg = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant($neg_inf),
        value => $neg_inf,
    );
    ...
    my $finite = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(5.0),
        value => 5.0,
    );
...
subtest 'Float constant folding' => sub {
    ...
    ok $optimized->isa('Chalk::IR::Node::Constant'),
        'Constant folding: 3.0 + 4.0 optimized to Constant';
...
subtest 'Newton\'s method: IR graph construction' => sub {
    ...
    my $start = Chalk::IR::Node::Start->new();
    my $S_const = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(2.0),
        value => 2.0,
    );
    my $guess_const = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(1.5),
        value => 1.5,
    );
    my $two_const = Chalk::IR::Node::Constant->new(
        type => Chalk::IR::Type::Float->constant(2.0),
        value => 2.0,
    );
