...
# Note: <=> operator not yet in chalk.bnf
...
parses_ok(q{ my $x = $obj->method($arg1, $arg2); }, 'method call with multiple arguments');

# Function calls
parses_ok(q{ my $x = foo(); }, 'function call');
parses_ok(q{ my $x = foo($arg); }, 'function call with argument');
parses_ok(q{ my $x = foo($arg1, $arg2); }, 'function call with multiple arguments');
