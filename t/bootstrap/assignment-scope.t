...
# Should create a new VarDecl with initializer and bind '$x' in scope
{
    ...
    ok($node isa Chalk::Bootstrap::IR::Node::Constructor, 'result is a Constructor node');
...
# Should create a VarDecl and bind '$x' in scope with the new VarDecl
{
    ...
    ok($node isa Chalk::Bootstrap::IR::Node::Constructor, 'plain assignment: result is a Constructor');
...
# Should create a CompoundAssign and bind '$x' in scope
{
    ...
    ok($node isa Chalk::Bootstrap::IR::Node::Constructor, 'compound assignment: result is a Constructor');
