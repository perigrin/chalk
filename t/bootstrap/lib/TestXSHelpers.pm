...
# ABOUTME: Exports helpers for grammar setup, file parsing to IR, and XS build/load.
use 5.42.0;
use utf8;
...
use Exporter 'import';
our @EXPORT_OK = qw(setup_xs_grammar parse_file_ir build_and_load);
...
# Sets up the grammar pipeline for XS tests.
