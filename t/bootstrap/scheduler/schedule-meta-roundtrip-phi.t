# ABOUTME: Tests for Chalk::Scheduler::Roundtrip::Phi schedule_data.
...
use lib 'lib';
use Chalk::IR::Node;
use Chalk::Scheduler::Roundtrip::Phi;
...
my $bare = Chalk::Scheduler::Roundtrip::Phi->new(node => $phi);
isa_ok($bare, 'Chalk::Scheduler::Roundtrip::Phi');
...
my $resolved = Chalk::Scheduler::Roundtrip::Phi->new(
    node      => $phi,
    emit_slot => $vardecl,
);
