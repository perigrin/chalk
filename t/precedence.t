#!/usr/bin/env perl
# ABOUTME: Test operator precedence and associativity parsing
# ABOUTME: Verifies that expressions parse with correct precedence rules
use 5.42.0;
use Test2::V0;
...
for my $test (@test_cases) {
    ...
    ok($is_correct, "$test->{description}: '$test->{expr}'");
