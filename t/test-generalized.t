...
ok defined($parser->parse(qw(num))), "Parse simple num without artificial start rule";
ok defined($parser->parse(qw(num + num))), "Parse addition without artificial start rule";