#!/usr/bin/env perl
# ABOUTME: Progressive test with HeredocV2 to find next failure
# ABOUTME: Test in 10-line increments with V2 preprocessing
use 5.42.0;
use utf8;
use lib 'lib';
...
print "Progressive lex.t parsing with HeredocV2\n";
...
if ($last_good == $total_lines) {
    print "\n✅ SUCCESS! Entire file parses with HeredocV2!\n";
} elsif ($last_good > 0) {
