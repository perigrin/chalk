# ABOUTME: Float less-than-or-equal comparison node in the IR graph
# ABOUTME: Represents <= comparison between two float values, returns integer (0 or 1)
use 5.42.0;
use experimental qw(class);
use utf8;

class Chalk::IR::Node::LEF {
    ...
    # Algebraic simplification for float less-than-or-equal comparison
    method idealize() {
        # x <= x -> 1 (self-comparison: everything is less-than-or-equal to itself)
