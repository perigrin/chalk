...
class Chalk::Grammar::Chalk::Type::Exception :isa(Chalk::Grammar::Chalk::Type::Scalar) {
    ...
    # Static factory method for type coercion errors
    sub type_coercion_error($class, $source_type, $target_type, $value = undef, $context = undef) {
    ...
    sub type_mismatch_error($class, $expected_type, $actual_type, $context = undef) {
    ...
    # Static method for information loss warnings
    sub information_loss_warning($class, $source_type, $target_type, $value, $context = undef) {
    ...
    # Static factory method for invalid list assignment errors
    sub invalid_list_assignment_error($class, $target_sigil) {
        my $msg = "Cannot assign List to variable with sigil '$target_sigil'. " .
    ...
    # Static factory method for membership failure errors
    sub membership_failure_error($class, $type, $value, $reason = undef) {
