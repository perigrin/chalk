...
class Chalk::Bootstrap::BNF::Target::C :isa(Chalk::Bootstrap::Target) {
    ...
    # Emit the shared runtime header chalk.h. Every generated .c file
    # includes this; build scripts write it alongside the generated sources.
    # The content is an invariant template — no per-grammar substitution.
    method generate_runtime_header() {
        return q[/* ABOUTME: Shared runtime header for Chalk-generated C semirings.
   ABOUTME: Auto-generated by Chalk::Bootstrap::BNF::Target::C. */
#ifndef CHALK_H
#define CHALK_H
