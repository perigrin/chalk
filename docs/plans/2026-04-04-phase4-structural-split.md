...
> Phase 4b (structural split) is complete. Phase 4a (SSA scope with
> Phi insertion) is absorbed into the MOP migration's Phase 3. The
> Hybrid Phi Strategy section remains the reference design for that
> implementation.
